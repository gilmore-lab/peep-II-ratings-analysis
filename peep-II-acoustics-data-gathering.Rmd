...
5. Create summary (mean value across utterances) data for each recording as this is the data in the JECP paper. Focus on the `F0_mean`, standard deviation of F0, and speech rate variables. Confirm with Peter how to calculate speech rate.
